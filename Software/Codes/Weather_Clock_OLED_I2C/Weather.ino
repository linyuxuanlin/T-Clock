...
void DisplayTime()
{
  if (OnTime == 0 or OnTime == 1)
  {
    ...
    display.print("loc: Swatow");//显示地区
    
    display.setTextSize(3);//设置字体大小
    display.setCursor(20, 25); //设置光标
...
void processMessage()
{
  ...
  const char* results_0_location_name = results_0_location["name"]; // "汕头"
  ...
  Serial.println(riqi.substring(nian - 10, nian - 6));//
